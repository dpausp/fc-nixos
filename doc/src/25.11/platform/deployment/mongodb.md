...
!!! warning
    This is a sunsetting version of the platform documentation. Go to [the current version](../../components/mongodb.md) for optimized support.
...
!!! warning
    ...
    [FerretDB role](../../components/ferretdb.md#nixos-ferretdb) which is currently in beta.
