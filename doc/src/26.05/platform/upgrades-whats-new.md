...
## General upgrade remarks { #nixos-upgrade-general }
...
## Significant breaking changes { #nixos-upgrade-breaking }

### Mailserver / Mailstub { #nixos-upgrade-mail }
...
### Percona / MySQL { #nixos-upgrade-percona }
...
### RabbitMQ { #nixos-upgrade-rabbitmq }
...
### Webproxy: Vinyl Cache and Varnish Cache { #nixos-upgrade-webproxy }
